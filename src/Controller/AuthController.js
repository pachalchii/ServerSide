                ...
                if(loginInfoCheck(req,res)) {
                    ...
                    if (req.body.PhoneNumber != null){
                        ...
                        customer.findAll({
                            ...
                            if (!isThisArrayEmpty(customer))
                            {
                                var payload = { Username: customer[0].Username,
                                    Password: customer[0].Password,
                                    random:Math.random()};
                ...
                if(loginInfoCheck(req,res)) {
                    if (req.body.PhoneNumber != null){
                        ...
                        transportation.findAll({
                            ...
                            if (!isThisArrayEmpty(trans))
                            {
                                var payload = { Username: trans[0].Username,
                                    Password: trans[0].Password,
                                    random:Math.random()};
                    ...
                    if (req.body.PhoneNumber != null){
                        support.findAll({
                            ...
                            if (!isThisArrayEmpty(support)){
                                var payload = { PhoneNumber: support[0].PhoneNumber,
                        ...
                        support.findAll({
                            ...
                            if (!isThisArrayEmpty(support))
                            {
                                var payload = { Username: support[0].Username,
                                    Password: support[0].Password,
                                    random:Math.random()};
                ...
                if(loginInfoCheck(req,res)){
                    ...
                    if (req.body.PhoneNumber != null){
                        ...
                        sellerWareHouse.findAll({
                            ...
                            if (!isThisArrayEmpty(wareHouse))
                            {
                                var payload = { Username: wareHouse[0].Username,
                                    Password: wareHouse[0].Password,
                                    random:Math.random()};
                ...
                if(loginInfoCheck(req,res)) {
                    if (req.body.PhoneNumber != null){
                        ...
                        sellerOperator.findAll({
                            ...
                            if (!isThisArrayEmpty(operator))
                            {
                                var payload = { Username: operator[0].Username,
                                    Password: operator[0].Password,
                                    random:Math.random()};
